						...
						<td>
							<FORM METHOD="post"
								...
								<input type="submit" value="通過"> <input type="hidden"
									name="rtr_no" value="${realtorVO.rtr_no}"> <input
									type="hidden" name="rtr_id" value="${realtorVO.rtr_id}">
								<input type="hidden" name="rtr_name"
									value="${realtorVO.rtr_name}"> <input type="hidden"
