        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <!-- All Blog posts -->
              <h1 class="text-primary wow fadeInDown text-uppercase text-center"  data-wow-duration="1s" data-wow-delay=".3s">好房事，讓你不僅房內事沒問題，房外事也處理好好</h1>
              <div class="text-center">
                <i class="text-muted align-center mar-bottom-sm"> 成家霸業 ForHouse</i>
              </div>
              <div class="text-center">
              ...
              <div class="row">
                <div class="col-md-4 col-xs-12 mar-bottom-md">
                    <div class="wow fadeInUp text-center" data-wow-duration="1s" data-wow-delay=".5s" id="cooper_run">
                        <div><br><br>讓你知道現在房市的最新消息!<br>想要買房的各路王公子爵們，覺得現在市場上，消息太多，又不知道如何分辨消息來源!?<br>沒有關係，因為真的假不了，假的不能真，江湖你在走，消息我們一定有!<br>讓你隨時掌握各路消息，霸業可成<br>
                        </div>
                        <div><br><br>俗語說:「化妝界牛耳，做菜界有阿基師、天界有比克大魔王」
                            <br>那你不可不知道，我們就是房屋界裡的牛耳、阿基師、比克大魔王!<br>我們隨時提供時下最新室內設計，木工裝修、還有如何逃漏稅，阿，不是，是對抗一大堆專業學問，讓你成就霸業，不需要費一兵一卒!
                        </div>
                    </div>
                </div>
                <div class="col-md-4 hidden-xs hidden-sm">
                  <div class="thumbnail mar-auto wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    <figure>
                      <img src="images/news_special.png" class="img-responsive" alt="" />  
                      <img src="images/news_special2.png" class="img-responsive" alt="" />                     
                      <div class="image-overlay">
                        <p>
                          <a href="images/news_special3.png" class="show-image">
                ...
                <div class="col-md-4">
                  <div class="wow fadeInUp text-center" data-wow-duration="1s" data-wow-delay=".5s" id="cooper_run2">
                        <div><br><br>讓你知道現在房市的最新消息!<br>想要買房的各路王公子爵們，覺得現在市場上，消息太多，又不知道如何分辨消息來源!?<br>沒有關係，因為真的假不了，假的不能真，江湖你在走，消息我們一定有!<br>讓你隨時掌握各路消息，霸業可成<br>
                        </div>
                        <div><br><br>俗語說:「化妝界牛耳，做菜界有阿基師、天界有比克大魔王」
                            <br>那你不可不知道，我們就是房屋界裡的牛耳、阿基師、比克大魔王!<br>我們隨時提供時下最新室內設計，木工裝修、還有如何逃漏稅，阿，不是，是對抗一大堆專業學問，讓你成就霸業，不需要費一兵一卒!
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="mar-top-lg">
                <ul class="isotope-blog">
                 ...
                 <!-- 房市新聞 =============================================================================================-->
                  ...
                  <li class="blog-post wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                    <p class="cat-links"> 
                        <a class="text-capitalize"><i class="iline2-tag27 no-margin"></i>房市最新消息</a>
                    </p>
				 ...
				 <!-- 結束促銷資訊 =============================================================================================-->
                  <li class="blog-post wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
                    <p class="cat-links"> 
                        <a class="text-capitalize"><i class="iline2-tag27 no-margin"></i>促銷資訊</a>
                    </p>
                    <span class="blog-date">
                      19
                      <small class="blog-month">jul</small>
                  ...
                  <c:forEach var="annVO" items="${annlist}" begin="<%=pageIndex%>"
	                  ...
	                  <li class="blog-post wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
	                    <p class="cat-links"> 
	                        <a class="text-capitalize"><i class="iline2-tag27 no-margin"></i>系統公告</a>
	                    </p>
	                    <span class="blog-date">
	                    <fmt:formatDate value="${annVO.ann_date}" pattern="MM"/>月
	                      <small class="blog-month"><fmt:formatDate value="${annVO.ann_date}" pattern="dd"/></small>
	                    </span>
	                    <div class="blog-body">
                ...
                <!-- 彈出系統公告內容 -->
				<div class="" style="display:none; margin-top:50em;" id="ann_jump">
