...
<body>
    ...
    <div id="myCarousel" class="carousel slide " data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/furniture_ad1.jpeg" alt="Image">
            ...
            <div class="item">
                <img src="images/furniture_ad2.jpeg" alt="Image">
                <div class="carousel-caption">
                    <h3>Image2</h3>
                    <p>more</p>
                </div>
            ...
            <div class="item">
                <img src="images/furniture_ad7.jpg" alt="Image">
                <div class="carousel-caption">
                    <h3>Image3</h3>
                    <p>more.</p>
                </div>
            ...
            <div class="item">
                <img src="images/furniture_ad3.jpeg" alt="Image">
                <div class="carousel-caption">
                    <h3>Image4</h3>
                    <p>more..</p>
                </div>
            ...
            <div class="item">
                <img src="images/furniture_ad4.jpeg" alt="Image">
                <div class="carousel-caption">
                    <h3>Image5</h3>
                    <p>more...</p>
                </div>
    ...
    <div class="searchSRS">
        <div class="container">
            <div class="col-xs-12 col-sm-4 ina">
                <a href="#">
                    <div class="imgbox">
                        <img src="images/SearchHouse.jpg">
            ...
            <div class="col-xs-12 col-sm-4 ina">
                <a href="#">
                    <div class="imgbox">
                        <img src="images/Home-Sofa-2.jpg">
                        <div class="text-center textbox">
                            <div class="textbackground ">
    ...
    <div class="jumbotron furnitureAd">
            ...
            <img src="images/furniture_ad6.jpg">
