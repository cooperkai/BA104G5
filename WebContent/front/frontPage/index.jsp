...
<body>
	...
	<nav class="navbar navbar-fixed-top"> <jsp:include
		page="/front/frontPage/navbar.jsp" /> </nav>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div>
					...
					<div class="joinbtn">
						<a class="btn btn-info btn-lg btn-block"
							href="seller/register.jsp" role="button"><h3>我 是 廠 商</h3></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="myCarousel" class="carousel slide " data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="<%=request.getContextPath()%>/images/furniture_ad1.jpeg"
					alt="Image">
			...
			<div class="item">
				<img src="<%=request.getContextPath()%>/images/furniture_ad2.jpeg"
					alt="Image">
				<div class="carousel-caption">
					<h3>Image2</h3>
					<p>more</p>
			...
			<div class="item">
				<img src="<%=request.getContextPath()%>/images/furniture_ad7.jpg"
					alt="Image">
				<div class="carousel-caption">
					<h3>Image3</h3>
					<p>more.</p>
			...
			<div class="item">
				<img src="<%=request.getContextPath()%>/images/furniture_ad3.jpeg"
					alt="Image">
				<div class="carousel-caption">
					<h3>Image4</h3>
					<p>more..</p>
			...
			<div class="item">
				<img src="<%=request.getContextPath()%>/images/furniture_ad4.jpeg"
					alt="Image">
				<div class="carousel-caption">
					<h3>Image5</h3>
					<p>more...</p>
			...
			<div class="searchbar col-sm-5 col-sm-offset-3">
				<form class="search">
					<div class="input-group">
						...
						</span> <input type="text" class="form-control" placeholder="關鍵字、學校、街道">
	...
	<div class="searchSRS">
		<div class="container">
			...
			<div class="col-xs-12 col-sm-4 ina">
				<a
					href="<%=request.getContextPath()%>/front/realtor/realtor_search.jsp">
					<div class="imgbox">
						...
						<div class="text-left textfix">
							<ul>
								<li><a href="#">Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Omnis, minima.</a></li>
								<br>
								<li><a href="#">Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Perferendis, recusandae!</a></li>
								<br>
								<li><a href="#">Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Fugiat, soluta?</a></li>
								<br>
								<li><a href="#">Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Placeat, neque.</a></li>
								<br>
								<li><a href="#">Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Libero, tenetur?</a></li>
								<br>
							</ul>
						</div>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="insert" method="post">
					...
					<div class="form-group margin-top">
						<input type="password" class="form-control box-width"
							id="password1" name="mem_psw" placeholder="密碼">
					</div>
					<div class="form-group margin-top">
						<input type="password" class="form-control box-width"
					...
					<div class="form-group margin-top">
						<input type="text" class="form-control box-width" id="mem_name"
							name="mem_name" placeholder="姓名">
					</div>
					<div class="form-group margin-top">
						<input type="text" class="form-control box-width" id="mem_addr"
							name="mem_addr" placeholder="地址">
					</div>
					<div class="[ form-group ]">
						<input type="checkbox" name="search_state"
						...
						<div class="[ btn-group ] magicbox">
							...
							</label> <label for="fancy-checkbox-info"
								class="[ btn btn-default active ]">
								我願意公開我的找房狀態，讓房仲能主動找到我 </label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-1 col-sm-11" id="aggrement">
							<div class="checkbox">
								<label> <input type="checkbox" name="aggrement"
									id="aggrement2"> 若要繼續註冊，請先閱讀並同意好房事的<a href="">服務條款</a>
									& <a href="">隱私權政策</a>
								</label>
							</div>
						</div>
