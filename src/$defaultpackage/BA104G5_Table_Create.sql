...
INSERT INTO PROMO (PROMO_NO, PROMO_FROM, PROMO_TO, PROMO_NAME, PROMO_CONTENT, PROMO_PHOTO, PROMO_STATE, EMP_NO)
VALUES('PRO'||LPAD(TO_CHAR(SEQ_PRO.NEXTVAL), 7, '0'), TO_DATE('20171111', 'YYYY-MM-DD'), TO_DATE('20171118', 'YYYY-MM-DD'), '年齡未滿房屋', '來就送折扣', '', '未上架', 'EM00000001');
...
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171103', 'YYYY-MM-DD'), TO_DATE('20171110', 'YYYY-MM-DD'), '有送有送有送有送有送有送有送有送', '90', 'OD00000003', '未使用', 'MB00000002', 'PRO0005003');
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171111', 'YYYY-MM-DD'), TO_DATE('20171118', 'YYYY-MM-DD'), '來就送折扣', '90', 'OD00000002', '未使用', 'MB00000003', 'PRO0005002');
