...
VALUES('ART'||LPAD(TO_CHAR(SEQ_ART.NEXTVAL), 7, '0'), 'RT00000001', '南瓜有裝扮就送大南瓜', TO_DATE('20170810', 'YYYY-MM-DD'), 'ON');
INSERT INTO ARTICLE (Article_No, Rtr_No, Article_body, Post_date, Article_State)
VALUES('ART'||LPAD(TO_CHAR(SEQ_ART.NEXTVAL), 7, '0'), 'RT00000002', '裝扮就送大南瓜', TO_DATE('20170910', 'YYYY-MM-DD'), 'ON');
INSERT INTO ARTICLE (Article_No, Rtr_No, Article_body, Post_date, Article_State)
VALUES('ART'||LPAD(TO_CHAR(SEQ_ART.NEXTVAL), 7, '0'), 'RT00000003', '裝扮就送大南瓜', TO_DATE('20171010', 'YYYY-MM-DD'), 'ON');
INSERT INTO ARTICLE (Article_No, Rtr_No, Article_body, Post_date, Article_State)
VALUES('ART'||LPAD(TO_CHAR(SEQ_ART.NEXTVAL), 7, '0'), 'RT00000004', '就送大南瓜', TO_DATE('20171110', 'YYYY-MM-DD'), 'ON');
INSERT INTO ARTICLE (Article_No, Rtr_No, Article_body, Post_date, Article_State)
VALUES('ART'||LPAD(TO_CHAR(SEQ_ART.NEXTVAL), 7, '0'), 'RT00000005', '送大南瓜', TO_DATE('20171210', 'YYYY-MM-DD'), 'ON');
...
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171010', 'YYYY-MM-DD'), TO_DATE('20171017', 'YYYY-MM-DD'), '有裝扮就送大南瓜有裝扮就送大南瓜', '90', 'OD00000002', '已使用', 'MB00000002', 'PRO0005001');
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171010', 'YYYY-MM-DD'), TO_DATE('20171017', 'YYYY-MM-DD'), '有裝扮就送大南瓜有裝扮就送大南瓜', '90', 'OD00000002', '已使用', 'MB00000003', 'PRO0005002');
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171010', 'YYYY-MM-DD'), TO_DATE('20171017', 'YYYY-MM-DD'), '有裝扮就送大南瓜有裝扮就送大南瓜', '90', 'OD00000003', '未使用', 'MB00000002', 'PRO0005003');
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171010', 'YYYY-MM-DD'), TO_DATE('20171017', 'YYYY-MM-DD'), '有裝扮就送大南瓜有裝扮就送大南瓜', '90', 'OD00000002', '未使用', 'MB00000003', 'PRO0005002');
INSERT INTO COUPON (CP_NO, CP_FROM, CP_TO, CP_CONTENT, CP_DISCOUNT, PDO_NO, CP_STATE, MEM_NO, PROMO_NO)
VALUES('COU'||LPAD(TO_CHAR(SEQ_COU.NEXTVAL), 7, '0'), TO_DATE('20171010', 'YYYY-MM-DD'), TO_DATE('20171017', 'YYYY-MM-DD'), '有裝扮就送大南瓜有裝扮就送大南瓜', '90', 'OD00000002', '未使用', 'MB00000002', 'PRO0005001');
